...
using DavidsBlog.Api.Common.Http;
using ErrorOr;
...
namespace DavidsBlog.Api.Common.Errors;

public class DavidsBlogProblemDetailsFactory : ProblemDetailsFactory
{
    private readonly ApiBehaviorOptions options;
    
    public DavidsBlogProblemDetailsFactory(IOptions<ApiBehaviorOptions> options)
    {
    ...
    private void ApplyProblemDetailDefaults(
        HttpContext httpContext,
